...
return [
    ...
    'title' => 'Bet Backend API',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API RESTful para processamento de apostas e pagamentos. Autenticação via Bearer Token (Laravel Sanctum).',
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtenha seu token via <code>POST /api/auth/login</code> e inclua-o como <code>Authorization: Bearer {token}</code>.',
    ],
